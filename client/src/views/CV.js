		...
		<>		
			...
			<div id="cv" class="instaFade">
				<div class="mainDetails">
					...
					<div id="name">
						<h2 class="quickFade delayTwo">Bruce Kieu - Resume</h2>
						<h3 class="quickFade delayThree">Geophysicist - Datascientist - Web Developer</h3>
					</div>
					
					<div id="contactDetails" class="quickFade delayFour">
						<ul>
							<li><i class='fa fa-linkedin'></i> <a href="www.linkedin.com/in/binh-kieu/">www.linkedin.com/in/binh-kieu/</a></li>
							<li><i class="fa fa-github"></i> <a href=" https://github.com/BinhKieu82  "> https://github.com/BinhKieu82  </a></li>
					...
					<section>
						...
						<div class="sectionContent">
							<article>
								...
								<p class="subDetails">Responsive Web Design - Full Stack</p>
							...
							<article>
								...
								<p class="subDetails">Petroleum  - Quant Analysis - Commerical</p>
